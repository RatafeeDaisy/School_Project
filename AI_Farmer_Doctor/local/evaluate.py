...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="./uie_model/model_best", help="The path of saved model that you want to load.")
    parser.add_argument("--test_path", type=str, default="./dataset/ner_train_data/test.txt", help="The path of test set.")
