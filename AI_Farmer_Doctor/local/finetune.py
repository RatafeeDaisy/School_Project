...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_path", default='./dataset/ner_train_data/train.txt', type=str,
                        help="The path of train set.")
    parser.add_argument("--dev_path", default='./dataset/ner_train_data/test.txt', type=str,
                        help="The path of dev set.")
    parser.add_argument("--save_dir", default='uie_model', type=str,
